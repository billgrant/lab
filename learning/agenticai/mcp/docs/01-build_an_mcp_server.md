...
Walking through the python version of the [Build an MCP server](https://modelcontextprotocol.io/docs/develop/build-server#python) tutorial.
...
Import packages to `weather.py` and setup the instance.
...
## Test the server with Claud Desktop
